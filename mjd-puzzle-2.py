...
class Expression(object):
    def __init__(self, op_type, args_l, args_r, value):
        ...
        if op_type in [ADD_SUB, MUL_DIV]:
            ...
            self.poss_negation   = op_type == ADD_SUB and (args_r or all(args_l.poss_negation))
            self.poss_reciprocal = op_type == MUL_DIV and (args_r or all(args_l.poss_reciprocal))
